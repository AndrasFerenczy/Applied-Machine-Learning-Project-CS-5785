...
2) Better training:
    ...
    - The different models created by gridsearch and their performance should be plotted in various ways, because that would be really nice to show in our write-up. (e.g.: how does the model's performance converge with different learning rate, number of tree's, etc.)
...
- Document overview:
    1. Select a nice Latex template on overleaf we can use 
    2. Configure it for the AML Write-Up
